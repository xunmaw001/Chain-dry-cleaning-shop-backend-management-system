...
public class DiquxinxiController {
    ...
    public R save(@RequestBody DiquxinxiEntity diquxinxi, HttpServletRequest request){
    	diquxinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiquxinxiEntity> wrapper = new EntityWrapper<DiquxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = diquxinxiService.selectCount(wrapper);
