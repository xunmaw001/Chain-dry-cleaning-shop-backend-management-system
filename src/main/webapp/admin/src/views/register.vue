  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">连锁干洗店后台管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='dianjia'" class="input-group">
			   <div class="label">店家名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dianjiamingcheng" class="input" type="text" placeholder="店家名称">
			   </div>
			 </div> -->
			<el-form-item label="店家名称" class="input" v-if="tableName=='dianjia'">
			  <el-input v-model="ruleForm.dianjiamingcheng" autocomplete="off" placeholder="店家名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dianjia'" class="input-group">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='dianjia'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='dianjia'">
			...
			<el-form-item label="店铺地址" class="input" v-if="tableName=='dianjia'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.dianjiamingcheng) && `dianjia` == this.tableName){
        this.$message.error(`店家名称不能为空`);
        return
      }
      if(`dianjia` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210129/264fba40495b4687bee32049302bd881.jpg");
		height: 100vh;
