<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="地区信息" prop="diquxinxi">
          <el-input v-model="ruleForm.diquxinxi" 
              placeholder="地区信息" clearable  :readonly="ro.diquxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="地区信息" prop="diquxinxi">
              <el-input v-model="ruleForm.diquxinxi" 
                placeholder="地区信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='diquxinxi'){
            this.ruleForm.diquxinxi = obj[o];
	    this.ro.diquxinxi = true;
            continue;
          }
        }
      }
