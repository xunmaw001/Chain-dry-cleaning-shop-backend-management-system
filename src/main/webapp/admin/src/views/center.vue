  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='yonghu'"  label="所在地区" prop="suozaidiqu">
          <el-select v-model="ruleForm.suozaidiqu" placeholder="请选择所在地区">
            <el-option
                v-for="(item,index) in yonghusuozaidiquOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='dianjia'"  label="店家名称" prop="dianjiamingcheng">
          <el-input v-model="ruleForm.dianjiamingcheng"               placeholder="店家名称" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='dianjia'"  label="负责人" prop="fuzeren">
          <el-input v-model="ruleForm.fuzeren"               placeholder="负责人" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='dianjia'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='dianjia'" label="店铺图片" prop="dianputupian">
          <file-upload
          tip="点击上传店铺图片"
          action="file/upload"
          :limit="3"
          ...
          @change="dianjiadianputupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='dianjia'"  label="所在地区" prop="suozaidiqu">
          <el-select v-model="ruleForm.suozaidiqu" placeholder="请选择所在地区">
            <el-option
                v-for="(item,index) in dianjiasuozaidiquOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='dianjia'"  label="店铺地址" prop="dianpudizhi">
          <el-input v-model="ruleForm.dianpudizhi"               placeholder="店铺地址" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='dianjia'"  label="经营范围" prop="jingyingfanwei">
...
export default {
  data() {
    return {
      ...
      yonghusuozaidiquOptions: [],
      dianjiasuozaidiquOptions: [],
    };
  },
  mounted() {
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        this.yonghusuozaidiquOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
    this.$http({
      ...
      if (data && data.code === 0) {
        this.dianjiasuozaidiquOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
  ...
  methods: {
    ...
    dianjiadianputupianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.dianjiamingcheng)&& 'dianjia'==this.flag){
        this.$message.error('店家名称不能为空');
        return
      }
      if( 'dianjia' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
