...
public class DianjiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		String token = tokenService.generateToken(user.getId(), username,"dianjia",  "店家" );
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DianjiaEntity dianjia, 
		HttpServletRequest request){
    ...
    public R add(@RequestBody DianjiaEntity dianjia, HttpServletRequest request){
    	...
    	dianjia.setUserid((Long)request.getSession().getAttribute("userId"));
